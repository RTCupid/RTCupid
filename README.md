<div style="background-color: #0d1117; padding: 2rem; border-radius: 15px; border: 3px solid #f0c6e7; box-shadow: 0 0 20px rgba(240, 198, 231, 0.4), 0 0 40px rgba(200, 230, 255, 0.2);">
